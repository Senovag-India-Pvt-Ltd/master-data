...
public class DeputedInstituteMasterController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addDeputedInstituteDetails(@RequestBody DeputedInstituteMasterRequest deputedInstituteMasterRequest){
    ...
    public ResponseEntity<?> editDeputedInstituteDetails(
            @RequestBody final EditDeputedInstituteMasterRequest editDeputedInstituteMasterRequest
    ) {
