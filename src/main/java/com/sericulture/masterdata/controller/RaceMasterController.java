...
public class RaceMasterController {
    ...
    @Operation(summary = "Insert Race Details", description = "Creates Race Details in to DB")
    @ApiResponses(value = {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"Race name should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"raceMaster\":[{\"id\":10,\"raceMasterName\":\"\"},{\"id\":11,\"raceMasterName\":\"race 1\"},{\"id\":13,\"raceMasterName\":\"race 2\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(raceMasterService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(raceMasterService.getPaginatedRaceMasterDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(raceMasterService.getById(id));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getByIdJoin(
        ...
        rw.setContent(raceMasterService.getByIdJoin(id));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getByMarketMasterId(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(raceMasterService.getByMarketMasterId(marketMasterId));
        return ResponseEntity.ok(rw);
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"raceMaster\":[{\"id\":10,\"raceMasterName\":\"\",\"raceMasterId\":1,},{\"id\":11,\"raceMasterName\":\"Shimoga\",\"raceMasterId\":1,},{\"id\":13,\"raceMasterName\":\"Hubli\",\"raceMasterId\":1,}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
