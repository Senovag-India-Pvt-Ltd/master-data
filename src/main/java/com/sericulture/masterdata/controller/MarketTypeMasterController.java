...
import com.sericulture.masterdata.service.MarketTypeMasterService;
...
@RestController
@RequestMapping("/v1/marketTypeMaster")
public class MarketTypeMasterController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":1,\"marketTypeMaster\":[{\"id\":1,\"marketTypeMasterName\":\"\"},{\"id\":2,\"marketTypeMasterName\":\"marketTypeMasterName 1\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        rw.setContent(marketTypeMasterService.getPaginatedMarketTypeMasterDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"marketTypeMaster\":[{\"id\":10,\"marketTypeMasterName\":\"\"},{\"id\":11,\"marketTypeMasterName\":\"marketTypeMaster 1\"},{\"id\":13,\"marketTypeMasterName\":\"marketTypeMaster 2\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(marketTypeMasterService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> deleteMarketTypeMasterDetails(
            @PathVariable final Integer id
    ) {
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(marketTypeMasterService.deleteMarketTypeMasterDetails(id));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(marketTypeMasterService.getById(id));
        return ResponseEntity.ok(rw);
    }
