...
@RestController
@RequestMapping("/v1/hdBoardCategoryMaster")
public class HdBoardCategoryMasterController {

    @Autowired
    HdBoardCategoryMasterService hdBoardCategoryMasterService;
    ...
    @Operation(summary = "Insert Board categoryMaster Details", description = "Creates Board categoryMaster Details in to DB")
    @ApiResponses(value = {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"hdBoardCategoryMaster name should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"hdBoardCategoryMaster\":[{\"id\":10,\"hdBoardCategoryName\":\"\"},{\"id\":11,\"hdBoardCategoryName\":\"Karnataka\"},{\"id\":13,\"hdBoardCategoryName\":\"Kerala\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(hdBoardCategoryMasterService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(hdBoardCategoryMasterService.getPaginatedHdBoardCategoryMasterDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> deleteHdBoardCategoryMasterDetails(
            @PathVariable final Integer id
    ) {
        ResponseWrapper<HdBoardCategoryMasterResponse> rw = ResponseWrapper.createWrapper(HdBoardCategoryMasterResponse.class);
        rw.setContent(hdBoardCategoryMasterService.deleteHdBoardCategoryMasterDetails(id));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(hdBoardCategoryMasterService.getById(id));
        return ResponseEntity.ok(rw);
    }
