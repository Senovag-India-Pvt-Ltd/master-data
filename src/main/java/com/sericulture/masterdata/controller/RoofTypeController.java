...
public class RoofTypeController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"roofType\":[{\"id\":10,\"roofTypeName\":\"\"},{\"id\":11,\"roofTypeName\":\"Roof Type 1\"},{\"id\":13,\"roofTypeName\":\"Roof Type 2\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(roofTypeService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":1,\"roofType\":[{\"id\":1,\"roofTypeName\":\"\"},{\"id\":2,\"roofTypeName\":\"roofTypeName 1\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(roofTypeService.getPaginatedRoofTypeDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(roofTypeService.getById(id));
        return ResponseEntity.ok(rw);
    }
