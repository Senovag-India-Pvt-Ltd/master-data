...
public class CasteController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?>addCasteDetails(@Valid @RequestBody CasteRequest casteRequest){
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"caste\":[{\"id\":10,\"casteName\":\"\"},{\"id\":11,\"casteName\":\"OBC 1\"},{\"id\":13,\"casteName\":\"OBC\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(casteService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
