...
public class DistrictController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addDistrictDetails(@Valid @RequestBody DistrictRequest districtRequest){
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"district\":[{\"id\":10,\"districtName\":\"\"},{\"id\":11,\"districtName\":\"DK\"},{\"id\":13,\"districtName\":\"Udupi\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(districtService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> editDistrictDetails(
            @Valid @RequestBody final EditDistrictRequest editDistrictRequest
    ) {
    ...
    public ResponseEntity<?> searchByName(
            @Valid @RequestBody final DistrictDTO districtDTO
    ) {
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(districtService.searchByName(districtDTO.getDistrictName()));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> search(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(districtService.searchByColumnAndSort(searchWithSortRequest));
        return ResponseEntity.ok(rw);
    }
}
