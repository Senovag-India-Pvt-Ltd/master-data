...
import com.sericulture.masterdata.service.SoilTypeService;
...
public class SoilTypeController {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"SoilType name should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(soilTypeService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(soilTypeService.getPaginatedSoilTypeDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(soilTypeService.getById(id));
        return ResponseEntity.ok(rw);
    }
}
