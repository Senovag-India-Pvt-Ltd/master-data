...
public class SilkWormVarietyController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"silkWormVariety\":[{\"id\":10,\"silkWormVarietyName\":\"\"},{\"id\":11,\"silkWormVarietyName\":\"Mulberry\"},{\"id\":13,\"silkWormVarietyName\":\"Eri\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(silkWormVarietyService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
