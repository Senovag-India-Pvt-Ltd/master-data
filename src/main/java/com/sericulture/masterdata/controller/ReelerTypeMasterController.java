...
public class ReelerTypeMasterController {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"Releer Type Master should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
            @ApiResponse(responseCode = "500", description = "Internal Server Error - Error occurred while processing the request.")
    })
    @PostMapping("/add")
    public ResponseEntity<?> addReleerTypeMasterDetails(@Valid @RequestBody ReelerTypeMasterRequest reelerTypeMasterRequest){
    ...
    public ResponseEntity<?> editReelerTypeMasterDetails(
            @Valid @RequestBody final EditReelerTypeMasterRequest editReelerTypeMasterRequest
    ) {
        ResponseWrapper<ReelerTypeMasterResponse> rw = ResponseWrapper.createWrapper(ReelerTypeMasterResponse.class);
