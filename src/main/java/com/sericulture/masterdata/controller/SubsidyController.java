...
import com.sericulture.masterdata.service.SubsidyService;
...
@RestController
@RequestMapping("/v1/subsidy")
public class SubsidyController {
    @Autowired
    SubsidyService subsidyService;

    @Operation(summary = "Insert Subsidy Details", description = "Creates Subsidy Details in to DB")
    @ApiResponses(value = {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"Subsidy name should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"subsidy\":[{\"id\":10,\"subsidyName\":\"\"},{\"id\":11,\"subsidyName\":\"Subsidy Name 1\"},{\"id\":13,\"subsidyName\":\"Subsidy Name 2\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(subsidyService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":1,\"subsidy\":[{\"id\":1,\"subsidyName\":\"\"},{\"id\":2,\"subsidyName\":\"Subsidy 1\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(subsidyService.getPaginatedSubsidyDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(subsidyService.getById(id));
        return ResponseEntity.ok(rw);
    }
