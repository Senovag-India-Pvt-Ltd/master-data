...
public class TrScheduleController {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"TrSchedule name should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"trSchedule\":[{\"id\":10,\"trName\":\"\"},{\"id\":11,\"trName\":\"Karnataka\"},{\"id\":13,\"trName\":\"Kerala\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(trScheduleService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(trScheduleService.getPaginatedTrScheduleDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"trSchedule\":[{\"id\":10,\"trName\":\"\",\"trScheduleId\":1,},{\"id\":11,\"trScheduleName\":\"Shimoga\",\"trScheduleId\":1,},{\"id\":13,\"trName\":\"Hubli\",\"trScheduleId\":1,}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getPaginatedTrScheduleDetailsWithJoin(
            @RequestParam(defaultValue = "0") final Integer pageNumber,
            @RequestParam(defaultValue = "5") final Integer size
    ) {
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(trScheduleService.getPaginatedTrScheduleDetailsWithJoin(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> deleteTrScheduleDetails(
            @PathVariable final Integer id
    ) {
        ResponseWrapper<TrScheduleResponse> rw = ResponseWrapper.createWrapper(TrScheduleResponse.class);
        rw.setContent(trScheduleService.deleteTrScheduleDetails(id));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(trScheduleService.getById(id));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getByIdJoin(
        ...
        rw.setContent(trScheduleService.getByIdJoin(id));
        return ResponseEntity.ok(rw);
    }
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Object saved details"),
