...
import com.sericulture.masterdata.service.ScSchemeDetailsService;
...
@RestController
@RequestMapping("v1/scSchemeDetails")
public class ScSchemeDetailsController {

    @Autowired
    ScSchemeDetailsService scSchemeDetailsService;
    ...
    @Operation(summary = "Insert Sc Scheme Details", description = "Creates Sc Scheme Details Details in to DB")
    @ApiResponses(value = {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"Sc Scheme Details should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"scSchemeDetails\":[{\"id\":10,\"schemeName\":\"\"},{\"id\":11,\"schemeName\":\"Karnataka\"},{\"id\":13,\"schemeName\":\"Kerala\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(scSchemeDetailsService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(scSchemeDetailsService.getPaginatedScSchemeDetailsDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> deleteScSchemeDetails(
            @PathVariable final Integer id
    ) {
        ResponseWrapper<ScSchemeDetailsResponse> rw = ResponseWrapper.createWrapper(ScSchemeDetailsResponse.class);
        rw.setContent(scSchemeDetailsService.deleteScSchemeDetailsDetails(id));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(scSchemeDetailsService.getById(id));
        return ResponseEntity.ok(rw);
    }
