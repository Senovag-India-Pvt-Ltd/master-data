...
public class VillageController {
    ...
    @Operation(summary = "Insert Village Details", description = "Creates Village Details in to DB")
    @ApiResponses(value = {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"Village name should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
            @ApiResponse(responseCode = "500", description = "Internal Server Error - Error occurred while processing the request.")
    })
    @PostMapping("/add")
    public ResponseEntity<?> addVillageDetails(@Valid @RequestBody VillageRequest villageRequest){
        ResponseWrapper rw = ResponseWrapper.createWrapper(VillageResponse.class);

        rw.setContent(villageService.insertVillageDetails(villageRequest));
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"village\":[{\"id\":10,\"villageName\":\"\",\"stateId\":1,},{\"id\":11,\"villageName\":\"Shimoga\",\"stateId\":1,},{\"id\":13,\"villageName\":\"Hubli\",\"stateId\":1,}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(villageService.getPaginatedVillageDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    @PostMapping("/edit")
    public ResponseEntity<?> editVillageDetails(
            @Valid @RequestBody final EditVillageRequest editVillageRequest
    ) {
        ResponseWrapper<VillageResponse> rw = ResponseWrapper.createWrapper(VillageResponse.class);
        rw.setContent(villageService.updateVillageDetails(editVillageRequest));
        return ResponseEntity.ok(rw);
    }
    ...
    @GetMapping("/get-by-hobli-id/{hobliId}")
    ...
    public ResponseEntity<?> getVillageDetailsByName(
            @Valid @RequestBody final VillageDTO villageDTO
    ) {
        ResponseWrapper rw = ResponseWrapper.createWrapper(VillageResponse.class);
