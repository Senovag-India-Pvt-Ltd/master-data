...
import com.sericulture.masterdata.service.MachineTypeMasterService;
...
@RestController
@RequestMapping("/v1/machine-type-master")
public class MachineTypeMasterController {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"MachineType name should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"machineTypeMaster\":[{\"id\":10,\"machineTypeMasterName\":\"\"},{\"id\":11,\"machineTypeMasterName\":\"machineTypeMaster 1\"},{\"id\":13,\"machineTypeMasterName\":\"machineTypeMaster 2\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(machineTypeMasterService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":1,\"machineType\":[{\"id\":1,\"machineTypeName\":\"\"},{\"id\":2,\"machineTypeName\":\"Machine type 1\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(machineTypeMasterService.getPaginatedMachineTypeMasterDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(machineTypeMasterService.getById(id));
        return ResponseEntity.ok(rw);
    }
