...
@RestController
@RequestMapping("/v1/hdStatusMaster")
public class HdStatusMasterController {
                    ...
                    content =
                            {
                                    ...
                                    @Schema(example = "{\"errorType\":\"VALIDATION\",\"message\":[{\"message\":\"hdStatusMaster name should be more than 1 characters.\",\"label\":\"name\",\"locale\":null}]}"))
                            }),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"hdStatusMaster\":[{\"id\":10,\"hdStatusName\":\"\"},{\"id\":11,\"hdStatusName\":\"Karnataka\"},{\"id\":13,\"hdStatusName\":\"Kerala\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        rw.setContent(hdStatusMasterService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getPaginatedList(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(hdStatusMasterService.getPaginatedHdStatusMasterDetails(PageRequest.of(pageNumber, size)));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> deleteHdStatusMasterDetails(
            @PathVariable final Integer id
    ) {
        ResponseWrapper<HdStatusMasterResponse> rw = ResponseWrapper.createWrapper(HdStatusMasterResponse.class);
        rw.setContent(hdStatusMasterService.deleteHdStatusMasterDetails(id));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getById(
        ...
        rw.setContent(hdStatusMasterService.getById(id));
        return ResponseEntity.ok(rw);
    }
