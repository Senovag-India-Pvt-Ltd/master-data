...
public class ReasonBidRejectMasterController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addReasonBidRejectMasterDetails(@Valid @RequestBody ReasonBidRejectMasterRequest reasonBidRejectMasterRequest){
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "No Content - inserted successfully",content =
                    {
                            @Content(mediaType = "application/json", schema =
                            @Schema(example = "{\"content\":{\"totalItems\":6,\"reasonBidRejectMaster\":[{\"id\":10,\"reasonBidRejectMasterName\":\"\"},{\"id\":11,\"reasonBidRejectMasterName\":\"Poor in quality 1\"},{\"id\":13,\"reasonBidRejectMasterName\":\"Poor in quality 2\"}],\"totalPages\":1,\"currentPage\":0},\"errorMessages\":[]}"))
                    }),
            @ApiResponse(responseCode = "400", description = "Bad Request - Has validation errors",
                    content =
                            {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(reasonBidRejectMasterService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> editReasonBidRejectMasterDetails(
            @Valid @RequestBody final EditReasonBidRejectMasterRequest editReasonBidRejectMasterRequest
    ) {
