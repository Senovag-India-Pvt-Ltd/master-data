...
public interface ReasonBidRejectMasterRepository extends PagingAndSortingRepository<ReasonBidRejectMaster, Long> {
    ...
    public List<ReasonBidRejectMaster> findByReasonBidRejectNameAndReasonBidRejectIdIsNot(String reasonBidRejectName, long reasonBidRejectId);
    ...
    public List<ReasonBidRejectMaster> findByActiveOrderByReasonBidRejectNameAsc(boolean isActive);
}
