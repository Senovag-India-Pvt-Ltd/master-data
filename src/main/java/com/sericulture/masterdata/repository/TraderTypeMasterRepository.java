...
public interface TraderTypeMasterRepository extends PagingAndSortingRepository<TraderTypeMaster,Long> {
    ...
    public List<TraderTypeMaster> findByActiveAndTraderTypeMasterNameAndTraderTypeNameInKannada(boolean a,String traderTypeMasterName,String traderTypeNameInKannada);
